const HEARIT_DATA = {
  ...
  "audio": {
    ...
    "lang": "en-US",
    "rate": 0.9,
    "migration_note": "Para migrar a MP3: generar un archivo por palabra en assets/audio/hearit/<PALABRA>.mp3 y cambiar SOLO la funcion playWord(). El resto del juego no se toca."
  },
  "rules": {
    "rounds_per_game": 8,
    "scoring": {
  ...
  "answer_checking": {
    ...
    "note": "Los homofonos estan excluidos de los niveles de escritura, asi que cada audio tiene una sola respuesta correcta posible."
  },
  "phonetic_contrasts": {
